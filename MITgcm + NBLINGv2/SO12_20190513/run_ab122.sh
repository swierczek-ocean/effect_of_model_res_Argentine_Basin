...
cd /xdisk/jrussell/mig2020/rsgrps/jrussell/swierczek/MITgcm/verification/SO12_20190513/

cp build/makescript_SO12_20190513.sh run/

rm -rf build/*

mv run/makescript_SO12_20190513.sh build/
...
cd /xdisk/jrussell/mig2020/rsgrps/jrussell/swierczek/MITgcm/verification/SO12_20190513/run
