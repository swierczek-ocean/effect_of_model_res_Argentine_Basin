...
cd /xdisk/jrussell/mig2020/rsgrps/jrussell/swierczek/MITgcm/verification/SO3_20190510/

cp build/makescript_SO3_20190510.sh run/

rm -rf build/*

mv run/makescript_SO3_20190510.sh build/
...
cd /xdisk/jrussell/mig2020/rsgrps/jrussell/swierczek/MITgcm/verification/SO3_20190510/run
