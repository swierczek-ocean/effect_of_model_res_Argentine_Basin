...
hold on
barh(Yb,Xbc,'FaceColor',Color(60,:),'LineWidth',1.6)
barh(Ya,Xac,0.165,'FaceColor',Color(59,:),'LineWidth',1.6)
grid on
ax2.GridAlpha = 1;
yticks(X)
ylim([0 50])
